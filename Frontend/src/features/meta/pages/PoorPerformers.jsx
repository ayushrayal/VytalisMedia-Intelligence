...
/**
 * Dedicated Poor Performers Page Component.
 * Route: /meta/poor-performers
 * Features:
 * - Displays creatives performing below the selected ROAS threshold (sorted worst ROAS first)
  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="Creatives performing below the selected ROAS threshold."
        actions={
      ...
      {loading ? (
        ...
        <PoorPerformersSection
          creatives={filteredData}
          preferences={cardPreferences}
          onCardClick={handleCardClick}
          onThresholdChange={handlePoorThresholdChange}
        />
      )}
